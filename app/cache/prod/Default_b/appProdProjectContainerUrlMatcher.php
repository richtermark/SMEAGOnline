...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::indexAction',  '_route' => 'homepage',  '_permission' =>   array (  ),);
        }
        ...
        if ($pathinfo === '/switch/language') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::translateAction',  '_route' => 'switch_language',  '_permission' =>   array (  ),);
        }

        // homepage_category
        if ($pathinfo === '/course/search') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::coursesCategoryAction',  '_route' => 'homepage_category',  '_permission' =>   array (  ),);
        }

        if (0 === strpos($pathinfo, '/l')) {
            // live_jump
            if ($pathinfo === '/live/jump') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::jumpAction',  '_route' => 'live_jump',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/a')) {
            ...
            if ($pathinfo === '/app/download') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::appDownloadAction',  '_route' => 'app_download',  '_permission' =>   array (  ),);
            }
        ...
        if (0 === strpos($pathinfo, '/c')) {
            ...
            if (0 === strpos($pathinfo, '/course')) {
                ...
                if (0 === strpos($pathinfo, '/course/task/m')) {
                    // course_task_question_markers_show
                    if (0 === strpos($pathinfo, '/course/task/media') && preg_match('#^/course/task/media/(?P<mediaId>[^/]++)/question_markers/show$#s', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/course/task/marker') && preg_match('#^/course/task/marker/(?P<markerId>[^/]++)/question_marker/(?P<questionMarkerId>[^/]++)/finish$#s', $pathinfo, $matches)) {
                        if ($this->context->getMethod() != 'POST') {
                            $allow[] = 'POST';
                            goto not_course_task_question_marker_finish;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'course_task_question_marker_finish')), array (  '_controller' => 'AppBundle\\Controller\\QuestionMarkerController::finishQuestionMarkerAction',  '_permission' =>   array (  ),));
                    }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (rtrim($pathinfo, '/') === '/admin') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::indexAction',  '_route' => 'admin',  '_permission' =>   array (  ),);
            }
            ...
            if ($pathinfo === '/admin/notice/modal') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::noticeAction',  '_route' => 'admin_notice_modal',  '_permission' =>   array (  ),);
            }
            ...
            if (0 === strpos($pathinfo, '/admin/course') && preg_match('#^/admin/course/(?P<courseId>[^/]++)/question/(?P<questionId>[^/]++)/remindTeachers$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_question_remind_teachers')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::questionRemindTeachersAction',  '_permission' =>   array (    0 => 'admin',  ),));
            }
            not_admin_question_remind_teachers:

            // admin_operation_analysis
            if ($pathinfo === '/admin/operation/analysis') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::operationAnalysisDashbordBlockAction',  '_route' => 'admin_operation_analysis',  '_permission' =>   array (    0 => 'admin',  ),);
            }
            ...
            if (0 === strpos($pathinfo, '/admin/user/statistic') && preg_match('#^/admin/user/statistic/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_user_statistic')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::userStatisticAction',  '_permission' =>   array (    0 => 'admin',  ),));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/task/learn/statistic') && preg_match('#^/admin/task/learn/statistic/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_task_learn_statistic')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::completedTaskStatisticAction',  '_permission' =>   array (    0 => 'admin',  ),));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/study/statistic') && preg_match('#^/admin/study/statistic/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_study_statistic')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::studyStatisticAction',  '_permission' =>   array (    0 => 'admin',  ),));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/order/statistic') && preg_match('#^/admin/order/statistic/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_order_statistic')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::orderStatisticAction',  '_permission' =>   array (    0 => 'admin',  ),));
            }
            ...
            if (0 === strpos($pathinfo, '/admin/course/explore') && preg_match('#^/admin/course/explore/(?P<period>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_explore')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::courseExploreAction',  '_permission' =>   array (    0 => 'admin',  ),));
            }

            // admin_dashboard
            if ($pathinfo === '/admin/dashboard') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::dashboardAction',  '_route' => 'admin_dashboard',  '_permission' =>   array (    0 => 'admin',  ),);
            }
            ...
            if (0 === strpos($pathinfo, '/admin/course_set') && preg_match('#^/admin/course_set/(?P<id>[^/]++)/close$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_course_set_close')), array (  '_controller' => 'AppBundle\\Controller\\Admin\\CourseSetController::closeAction',  '_permission' =>   array (    0 => 'admin_course_close',  ),));
            }
            ...
            if ($pathinfo === '/admin/system/status') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::systemStatusAction',  '_route' => 'admin_system_status',  '_permission' =>   array (    0 => 'admin',  ),);
            }

            // admin_official_messages
            if ($pathinfo === '/admin/official/messages') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::officialMessagesAction',  '_route' => 'admin_official_messages',  '_permission' =>   array (    0 => 'admin',  ),);
            }
            ...
            if ($pathinfo === '/admin/feedback') {
                return array (  '_controller' => 'AppBundle\\Controller\\Admin\\DefaultController::feedbackAction',  '_route' => 'admin_feedback',  '_permission' =>   array (    0 => 'admin',  ),);
            }
