...
class __TwigTemplate_863864208a0da19142792b2d04dc7d5721287dbfd2ed3e438b579d03c7567518 extends Twig_Template
{
  ...
  <form id=\"user-search-form\" class=\"form-inline well well-sm\" action=\"\" method=\"get\" novalidate>
    <div class=\"mbm\">
      ...
      <select class=\"form-control\" name=\"datePicker\" id=\"datePicker\">
        ";
        // line 17
        echo $this->env->getExtension('AppBundle\Twig\HtmlExtension')->selectOptions(array("longinDate" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("登录时间"), "registerDate" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("注册时间")), $this->getAttribute($this->getAttribute(($context["app"] ?? null), "request", array()), "get", array(0 => "datePicker"), "method"), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("--时间类型--"));
        echo "
      </select>
    ...
    <div class=\"form-group\">
      ...
      <select class=\"form-control\" name=\"roles\">
        ";
        // line 30
        echo $this->env->getExtension('AppBundle\Twig\HtmlExtension')->selectOptions($this->env->getExtension('AppBundle\Twig\WebExtension')->arrayMerge($this->env->getExtension('Codeages\PluginBundle\Twig\DictExtension')->getDict("userRole"), ($context["allRoles"] ?? null)), $this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? null), "request", array()), "query", array()), "get", array(0 => "roles"), "method"), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("--所有角色--"));
        echo "
      </select>
    </div>
    ...
    <div class=\"form-group\">
      <select id=\"keywordUserType\" name=\"keywordUserType\" class=\"form-control\">
        ";
        // line 37
        echo $this->env->getExtension('AppBundle\Twig\HtmlExtension')->selectOptions($this->env->getExtension('Codeages\PluginBundle\Twig\DictExtension')->getDict("userType"), $this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? null), "request", array()), "query", array()), "get", array(0 => "keywordUserType"), "method"), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("--注册来源--"));
        echo "
      </select>
    </div>
  ...
  <table id=\"user-table\" class=\"table table-striped table-hover\" data-search-form=\"#user-search-form\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            // line 83
            echo "      ";
            $this->loadTemplate("admin/user/user-table-tr.html.twig", "admin/user/index.html.twig", 83)->display(array_merge($context, array("user" => $context["user"], "profile" => $this->getAttribute(($context["profiles"] ?? null), $this->getAttribute($context["user"], "id", array()), array(), "array"))));
            // line 84
            echo "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return array (  218 => 89,  215 => 88,  211 => 85,  197 => 84,  194 => 83,  177 => 82,  170 => 80,  162 => 75,  158 => 74,  154 => 73,  148 => 71,  146 => 70,  141 => 69,  137 => 67,  135 => 66,  125 => 58,  118 => 56,  115 => 55,  113 => 54,  105 => 49,  101 => 48,  93 => 43,  84 => 37,  74 => 30,  63 => 24,  55 => 21,  48 => 17,  39 => 11,  36 => 10,  33 => 9,  29 => 3,  27 => 7,  25 => 5,  11 => 3,);
    }
    ...
    {
        return new Twig_Source("", "admin/user/index.html.twig", "/Applications/MAMP/htdocs/smeagonline/app/Resources/views/admin/user/index.html.twig");
    }
}
