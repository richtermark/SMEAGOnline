...
class __TwigTemplate_2265cbfd82af5d3653dee9b2b9c936f1165121702377222c15daf5a9609472f7 extends Twig_Template
{
...
";
        ...
        if (($context["include_config"] ?? null)) {
            ...
            echo twig_escape_filter($this->env, ($context["fallback"] ?? null), "js", null, true);
            echo "';
    Translator.defaultDomain = '";
            // line 4
            echo twig_escape_filter($this->env, ($context["defaultDomain"] ?? null), "js", null, true);
            echo "';
";
        }
        // line 6
...
";
    ...
    {
        return new Twig_Source("", "BazingaJsTranslationBundle::getTranslations.js.twig", "/Applications/MAMP/htdocs/smeagonline/vendor/willdurand/js-translation-bundle/Bazinga/Bundle/JsTranslationBundle/Resources/views/getTranslations.js.twig");
    }
}
